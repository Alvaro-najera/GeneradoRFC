    ...
    <div class="grid">
        <div class="col-12 md:col-12">
            <div class="card p-fluid">
                ...
                <div class="field">
                    <label for="apat1">Apellido Paterno:</label>
                    <InputText id="apat1" type="text" />
                </div>
                <div class="field">
                    <label for="apmat1">Apellido Materno:</label>
                    <InputText id="apmat1" type="text" />
                </div>
                <div class="field">
                    <label for="date">Fecha de Nacimiento:</label>
                    <Calendar :showIcon="true" :showButtonBar="true" v-model="calendarValue" placeholder="dd/mm/aaaa"></Calendar>
                </div>
                <div class="field">
                ...
                <div class="col-12 md:col-6">
                    <Button label="Generar" class="p-button-success mr-2 mb-2" />
                </div>
            </div>
